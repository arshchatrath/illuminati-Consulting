...
// Phones: a tall, narrow frame can't use the desktop zooms. Each shot names the part of the
// scene that must stay in view, [centre x, centre y, width, height], and the camera fits that
// box into whatever shape the frame has.
const CAM_PHONE = {
...
export function initPage({ lamp = true } = {}) {
  ...
  function phoneCam(key) {
    ...
    const [cx, cy, bw, bh] = CAM_PHONE[key.c];
